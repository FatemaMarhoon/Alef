        ...
        <>
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
                ...
                <div className="text-center">
                    <h1 className="mt-4 text-3xl font-bold tracking-tight text-primary sm:text-5xl">Recieved Successfully!</h1>
                    <p className="mt-6 text-base leading-7 text-gray-600">Your subscription request has been recieved and is currently under review. You'll be notified once approved.</p>
