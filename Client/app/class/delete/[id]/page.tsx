...
// export default function DeleteClassPage({ params }: { params: { id: number } }) {
...
//                 console.log('Updated Class Details State:', classDetailsData);
...
//         if (confirmDelete) {
//             try {
//                 const response = await deleteClass(classId.toString());
//                 // Redirect to a page or perform additional actions after deletion
...
//     return (
//         <>
//         <Breadcrumbs previousName='Classes' currentName='Delete' pageTitle="Delete Class" previousPath='/class' />
