...
const SignIn: React.FC = () => {
  ...
  const { successMessage, clearSuccessMessage, setSuccessMessage } = useSuccessMessageContext();
              ...
              <form onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="mb-5">
                  <input
                    ...
                    value="Sign In"
                    className="w-full cursor-pointer rounded-lg border text-center font-medium border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>
