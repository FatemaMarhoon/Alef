...
export default function CreateForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (connectedStaff == 0) {
        setError("A staff must be selected.")
      } else {
                ...
                <div className="mb-4.5">
                  ...
                  <div className="relative z-20 bg-transparent dark:bg-form-input">
                    <select
                      ...
                      {staffList.length == 0 && <option value="" className="text-danger">All existing staff have accounts already.</option>}
                      {staffList.length > 0 && <option value="">Select Staff</option>}
