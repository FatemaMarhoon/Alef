    ...
    useEffect(() => {
        async function fetchStaff() {
            try {
                ...
                setLoading(false); // Set loading to false once error

            }
        }

        fetchStaff();
        console.log("Message on Staff load: ", successMessage);
                        ...
                        <table className="w-full table-auto">
                            <thead>
                                <tr className="bg-gray-2 text-left dark-bg-meta-4">
                                    ...
                                    <th className="py-4 px-4 font-medium text-black dark-text-white">                                Actions
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
