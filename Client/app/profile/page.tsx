...
const ProfilePage = () => {
  ...
  if (preschoolId === null) {
    // You might want to show a loading spinner or handle the loading state differently
    return <Loader />;
  }

  return (
    <div>
      {/* Render the Profile component with the preschoolId */}
      <Profile id={preschoolId} />
    </div>
  );
};
