...
const AppProfile: React.FC<ProfileProps> = (props) => {
    ...
    async function fetchPreschool() {
        try {
            ...
            if (preschool.Address) {
                ...
                if (preschool.Address.latitude && preschool.Address.longitude) {
                    setSelectedLatitude(preschool.Address.latitude);
                    setSelectedLongitude(preschool.Address.longitude);
                }
            }
    ...
    const handleLocationChange = useCallback((latitude: number, longitude: number) => {
        console.log("Profile Location: ", "lat: ", latitude, " and long: ", longitude);
    ...
    async function handleUpdateLocation() {
        try {
            ...
            updatedAddress.latitude = selectedLatitude;
            updatedAddress.longitude = selectedLongitude;

            console.log("Address in update: ", updatedAddress);
            console.log("NEw lat:", selectedLatitude)
            console.log("NEw long:", selectedLongitude)
            // address.latitude = selectedLatitude;
            // address.longitude = selectedLongitude;
            const response = await updatePreschoolAddress(updatedAddress);
            ...
            {!loading && !notFound && authorized && (
                <div className="mx-auto max-w-290">
                    ...
                    <div className="grid grid-cols-5 gap-8">
                        ...
                        <div className="col-span-5 xl:col-span-2">
                            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                                <div className="border-b border-stroke py-4 px-7 dark:border-strokedark flex items-center">
