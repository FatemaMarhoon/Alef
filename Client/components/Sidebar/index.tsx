...
import { getPlan, currentPreschool, currentUserRole } from "@/services/authService";
import { getPreschoolById } from "@/services/preschoolService";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // const plan = preschool.plan_id;
        // console.log(plan);
        // setPlan(plan);
        const user = await currentUserRole();
        setRole(user);
        console.log("role", role);
        const plan: number = await getPlan();
        setPlan(plan);
    ...
    // Note: If you need to return a cleanup function, you can do so here
  }, [role]);
