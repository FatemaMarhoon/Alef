...
router.post('/', StationaryRequestController.createStationaryRequest);

// Update stationary request
router.put('/:request_id', StationaryRequestController.updateStationaryRequest);

// Delete stationary request
router.delete('/:request_id', StationaryRequestController.deleteStationaryRequest);
